...
class Artikels extends Model
{
    ...
    public function pakbonnen(): HasManyThrough
    {
        return $this->hasManyThrough(
            Pakbonnen::class,
            Sscc::class,
            'artikel_id', // Foreign key on SSCC table
            'id',         // Foreign key on Pakbonnen table
            'id',         // Local key on Artikels table
            'pakbon_id'   // Local key on SSCC table
        )->distinct()->orderBy('pakbonnen.pakbonDatum', 'desc');
    }
