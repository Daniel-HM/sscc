        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('pakbonnen.list')" :active="request()->routeIs('pakbonnen.list')"
                                wire:navigate>
                        {{ __('Pakbonnen') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('leveranciers')" :active="request()->routeIs('leveranciers')"
                                wire:navigate>
                        {{ __('Leveranciers') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('leveranciers')" :active="request()->routeIs('leveranciers')"
                                   wire:navigate>
                {{ __('Leveranciers') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('upload.show')" :active="request()->routeIs('upload.show')"
                                   wire:navigate>
                {{ __('Upload') }}
            </x-responsive-nav-link>
