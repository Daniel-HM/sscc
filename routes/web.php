...
// Basic EAN13 barcode generation (SVG format by default - more reliable)
Route::get('/barcode/{code}', function($code) {
    return app(BarcodeController::class)->generateEan13($code, 'svg');
...
// EAN13 barcode with custom dimensions (SVG by default)
Route::get('/barcode/{code}/{width}/{height}', function($code, $width, $height) {
    return app(BarcodeController::class)->generateCustomEan13($code, $width, $height, 'svg');
